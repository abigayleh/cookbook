  ...
  return (
    <Box sx={{ display: "flex", width: "100%" }}>
      {location.pathname.includes('/side') ? (
        <Box>
          <Typography sx={{ width: "100%", textDecoration: "underline", textAlign: "center", fontWeight: "bold", fontSize: "28px", paddingTop: "12px", color: "#662d91" }}>Side Dishes:</Typography>
        ...
        <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "space-around" }}>
          ...
          <Box sx={{ paddingBottom: "5px" }} />
          <Typography sx={{ width: "100%", textDecoration: "underline", textAlign: "center", fontWeight: "bold", fontSize: "28px", paddingTop: "12px", color: "#662d91" }}>Desserts:</Typography>
          <Box sx={{ display: "flex", flexWrap: "wrap", justifyContent: "center" }}>
